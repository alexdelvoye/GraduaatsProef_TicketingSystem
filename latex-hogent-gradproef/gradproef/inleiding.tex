...
\begin{itemize}[itemsep=0.1\baselineskip, topsep=0.25\baselineskip]
  \item Hoe krijgen HTTP, workflow, databanktoegang en businessregels elk een duidelijke plaats in de backend?
